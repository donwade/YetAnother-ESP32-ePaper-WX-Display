...
const char* ssid     = "ignite wifi"; //STRINGIZE_VALUE_OF(MY_SSID);             // WiFi SSID to connect to
const char* password = STRINGIZE_VALUE_OF(MY_SSID_PASSWORD);   //WiFi password needed for the SSID

// Use your own API key by signing up for a free developer account at https://openweathermap.org/
String apikey       = STRINGIZE_VALUE_OF(MY_OWM_APIKEY);    // See: https://openweathermap.org/  // It's free to get an API key, but don't take more than 60 readings/minute!
...
String Latitude  = "45.2946212";
String Longitude = "-75.8637158";
String City             = "Ottawa";                        // Your home city See: http://bulk.openweathermap.org/sample/
String Country          = "CA";                            // Your _ISO-3166-1_two-letter_country_code country code, on OWM find your nearest city and the country code is displayed
